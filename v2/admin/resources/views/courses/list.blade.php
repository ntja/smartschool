                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <ul class="list-unstyled">
                                            <li><b class="fa fa-filter"></b> <span><span class="filter-item label label-default" id="status_pending">PUBLISHED</span></span>&nbsp;<span><span class="filter-item label label-default" id="status_approved">UNPUBLISHED</span></span></li>
                                        </ul>
                                    </div>
                                </div>
                                <!-- <div class="row">
...
<script src="{{asset('js/courses/list.js')}}"></script>
