                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="table table-responsive">
                            <div id="listSkills_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <table id="listSkills" class="table dataTable display" role="grid" aria-describedby="listSkills_info" cellspacing="0" width="100%">
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting_asc" tabindex="0" aria-controls="listSkills" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending">Name</th>
                                                    <th>Status</th>
                                                    <th>Actions</th>
                                                </tr>
                                            </thead>
...
<!--                                    <div class="col-sm-7">
                                        <div id="listSkills_paginate" class="dataTables_paginate paging_simple_numbers">
                                            <ul class="pagination">
                                                <li id="listSkills_previous" class="paginate_button previous">
                                                    <a href="#" id="previous"  hidden="hidden">Previous</a>
                                                </li>
                                                <li id="listSkills_next" class="paginate_button next">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Disabling skill</h4>
                </div>
                <div class="modal-body">
                    Do you really want to disable this skill ?
                </div>
                <div class="modal-footer">
                    <span class="pull-left"><button class="btn btn-danger pull-left" id="deleteSkill">Yes</button></span>
    ...
    <div class="modal fade" id="activate">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">x</button>
                    <h4 class="modal-title">Skill Activation</h4>
                </div>
                <div class="modal-body">
                    Do you really want to activate this skill ?
                </div>
                <div class="modal-footer">
    ...
    <div class="modal modal-danger" id="result">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
...
<script src="{{asset('js/settings/skills/skills.js')}}"></script>
