            ...
            <div class="col-lg-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Institution names</h3>
                    </div><!-- /.box-header -->
                            ...
                            <div id="listJobs_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <table id="listInst_N" class="table dataTable display" role="grid" aria-describedby="listInst_N_info" cellspacing="0" width="100%">
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting_asc" tabindex="0" aria-controls="listInst_N" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending">Name</th>
                                                    <th>Status</th>
                                                    <th>Actions</th>
                                                </tr>
                                            </thead>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Disabling institution name</h4>
                </div>
                <div class="modal-body">
                    Do you really want to disable this institution name ?
                </div>
                <div class="modal-footer">
                    <span class="pull-left"><button class="btn btn-danger pull-left" id="deleteIname">Yes</button></span>
    ...
    <div class="modal fade" id="activate">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">x</button>
                    <h4 class="modal-title">Institution Name Activation</h4>
                </div>
                <div class="modal-body">
                    Do you really want to activate this institution name ?
                </div>
                <div class="modal-footer">
...
<script src="{{asset('js/settings/institutionnames/list.js')}}"></script>
