        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Disabling language</h4>
                </div>
                <div class="modal-body">
                    Do you really want to disable this language ?
                </div>
    ...
    <div class="modal fade" id="activate">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">x</button>
                    <h4 class="modal-title">Language Activation</h4>
                </div>
                <div class="modal-body">
                    Do you really want to activate this language ?
                </div>
                <div class="modal-footer">
...
<script src="{{asset('js/settings/languages/list.js')}}"></script>
