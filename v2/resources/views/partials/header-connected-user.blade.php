	...
	<div class="row">
		...
		<div class="col-md-4 col-md-offset-5 col-sm-offset-0 col-xs-offset-0 col-sm-9 col-xs-9">	
			...
			<ul class="user_panel user">
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">{{__('Welcome')}}, <strong id="user_name">User Name</strong> <b class="caret"></b></a>
					<ul class="dropdown-menu">
						<li><a href="#"><i class=" icon-user"></i> {{__('Courses Catalog')}} </a></li>
						<li><a href="#"><i class=" icon-download"></i> {{__('My Courses')}}</a></li>
