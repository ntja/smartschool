    ...
    public function dbSave($params) {
        ...
        try {            
            ...
            if (array_key_exists("shortdescription", $params)) {
                //throw new Exception("Expected key (shortdescription) in parameter array.");
            ...
            if (array_key_exists("smallicon", $params)) {
                //throw new Exception("Expected key (smallicon) in parameter array.");
            ...
            if (array_key_exists("smalliconhover", $params)) {
                //throw new Exception("Expected key (smalliconhover) in parameter array.");
            ...
            if (array_key_exists("instructor", $params)) {
                //throw new Exception("Expected key (instructor) in parameter array.");
