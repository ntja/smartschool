        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Disabling License</h4>
                </div>
                <div class="modal-body">
                    Do you really want to disable this License ?
                </div>
    ...
    <div class="modal fade" id="activate">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">x</button>
                    <h4 class="modal-title">License Activation</h4>
                </div>
                <div class="modal-body">
                    Do you really want to activate this License ?
                </div>
                <div class="modal-footer">
...
<script src="{{asset('js/settings/licenses/list.js')}}"></script>
