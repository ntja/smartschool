            ...
            <div class="col-lg-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Company names</h3>
                    </div><!-- /.box-header -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Disabling company name</h4>
                </div>
                <div class="modal-body">
                    Do you really want to disable this company name ?
                </div>
    ...
    <div class="modal fade" id="activate">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">x</button>
                    <h4 class="modal-title">Company Name Activation</h4>
                </div>
                <div class="modal-body">
                    Do you really want to activate this company name ?
                </div>
                <div class="modal-footer">
...
<script src="{{asset('js/settings/companynames/list.js')}}"></script>
