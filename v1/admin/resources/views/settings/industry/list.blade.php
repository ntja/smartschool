                            ...
                            <div id="listJobs_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <table id="listJobs" class="table dataTable" role="grid" aria-describedby="listJobs_info" cellspacing="0" width="100%">
                                            <thead>
                                                <tr role="row">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Disabling industry</h4>
                </div>
                <div class="modal-body">
                    Do you really want to disable this industry ?
                </div>
    ...
    <div class="modal fade" id="activate">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">x</button>
                    <h4 class="modal-title">Industry Activation</h4>
                </div>
                <div class="modal-body">
                    Do you really want to activate this industry ?
                </div>
                <div class="modal-footer">
...
<script src="{{asset('js/settings/industry/list.js')}}"></script>
