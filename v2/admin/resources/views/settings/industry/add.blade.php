			...
			<h3>Add Industry</h3>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
						...
						<form action="#" id="edit_industry" onsubmit="return false;">
					...
					<div class="box-footer">
						...
						<span><button class="btn btn-info pull-right" type="submit" form="edit_industry" id="save_btn">Save</button></span>
                    </div>
...
@section('script-footer')
    ...
    <script src="{{asset('js/settings/industry/add.js')}}"></script>
