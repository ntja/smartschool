			...
			<h3>Add Security Clearance</h3>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
						...
						<form action="#" id="edit_status" onsubmit="return false;">
					...
					<div class="box-footer">
						...
						<span><button class="btn btn-info pull-right" type="submit" form="edit_status" id="save_btn">Save</button></span>
                    </div>
...
@section('script-footer')
    ...
    <script src="{{asset('js/settings/securityclearances/add.js')}}"></script>
