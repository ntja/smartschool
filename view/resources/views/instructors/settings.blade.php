        ...
        <div class="page-container page-navigation-top">                
            ...
            <div class="page-content">
               ...
               @include('instructors/partials.header')
                 ...
                 <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="{{url('/instructors/dashboard')}}">{{trans('instructor.settings-1')}}</a></li>
                    <li class="active">{{trans('instructor.settings-2')}}</li>
                </ul>
                <!-- END BREADCRUMB -->    
                    ...
                    <div class="col-md-3">                            
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">                                    
                                    <div class="row">
                                        <div class="col-md-6">
                                            <button class="btn btn-primary btn-rounded btn-block"><span class="fa fa-question"></span> {{trans('instructor.settings-3')}}</button>
                                        </div>
                                        <div class="col-md-6">
                                            <button class="btn btn-primary btn-rounded btn-block"><span class="fa fa-comments"></span> {{trans('instructor.settings-4')}}</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-body list-group border-bottom">
                                    <a href="#" class="list-group-item"><span class="fa fa-bar-chart-o"></span> {{trans('instructor.settings-7')}}<span class="badge badge-warning">0</span></a>                                
                                    <a href="#" class="list-group-item"><span class="fa fa-folder"></span> {{trans('instructor.settings-8')}}<span class="badge badge-primary">0</span></a>                                
                                    <a href="#" class="list-group-item"><span class="fa fa-group"></span> {{trans('instructor.settings-9')}} <span class="badge badge-default">0</span></a>                                
                                    <a href="#" class="list-group-item"><span class="fa fa-users"></span> {{trans('instructor.settings-10')}} <span class="badge badge-danger">0</span></a>                                    
                                </div>
               ...
               <div class="col-md-9">                                                                                    
                    <div class="panel panel-default tabs">                            
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="active"><a href="#tab-first" role="tab" data-toggle="tab"><span class="fa fa-user"></span> {{trans('instructor.settings-5')}}</a></li>
                            <li><a href="#tab-second" role="tab" data-toggle="tab"><span class="fa fa-credit-card"></span> {{trans('instructor.settings-6')}} </a></li>
                        </ul>
                                        ...
                                        <div class="panel-body">
                                            <div class="row">         
                                                ...
                                                <div class="form-group">
                                                        <label class="col-md-3 control-label">{{trans('instructor.settings-11')}}</label>
                                                        <div class="col-md-9">                                        
                                                    ...
                                                    <div class="form-group">
                                                        <label for="email" class="col-md-3 control-label">{{trans('instructor.settings-12')}}</label>
                                                        <div class="col-md-9">                                            
                                                    ...
                                                    <div class="form-group">
                                                        <label for="password" class="col-md-3 control-label">{{trans('instructor.settings-13')}}</label>
                                                        <div class="col-md-9">                                            
                                                            <div class="input-group">
                                                    ...
                                                    <div class="form-group">
                                                       <label for="confirmation_password" class="col-md-3 control-label">{{trans('instructor.settings-14')}}</label>
                                                        <div class="col-md-9">                                            
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><span class="fa fa-lock"></span></span>
                                                ...
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                        <label for="first_name" class="col-md-3 control-label">{{trans('instructor.settings-15')}}</label>
                                                        <div class="col-md-9">                                            
                                                            <div class="input-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="first_name" class="col-md-3 control-label">{{trans('instructor.settings-16')}}</label>
                                                        <div class="col-md-9">                                            
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><span class="fa fa-user"></span></span>
                                                    ...
                                                    <div class="form-group">                                        
                                                        <label for="tel" class="col-md-3 control-label">{{trans('instructor.settings-17')}}</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="photo" class="col-md-3 control-label">{{trans('instructor.settings-18')}}</label>
                                                        <div class="col-md-9">
...
<script src="{{asset('js/instructors/settings.js')}}"></script>
@stop