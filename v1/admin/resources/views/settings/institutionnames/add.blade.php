            ...
            <div class=" col-md-6">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form action="#" id="edit_in" onsubmit="return false;">
                    ...
                    <div class="box-footer">
                        ...
                        <span><button class="btn btn-info pull-right" type="submit" form="edit_in" id="save_btn">Save</button></span>
                    </div>
...
<script src="{{asset('js/settings/institutionnames/add.js')}}"></script>
