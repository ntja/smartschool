...
class AccountCustom {
	...
	protected $_subscriptionsCustom;
	protected $_candidateSkillsCustom;
	protected $_candidateCertificationsCustom;
	protected $_candidateEducationCustom;
	protected $_candidateExperienceCustom;
	protected $_candidatePreferenceCustom;
