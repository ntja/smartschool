...
<head>
  ...
  <title>SmartSchool Admin Panel | Log in</title>
...
<body class="hold-transition login-page"  data-base-url="<?php echo URL::to('/'); ?>" data-locale="<?php echo App::getLocale(); ?>">
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Smart</b>School</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <h4 class="login-box-msg">Sign in to start your session </h4>
	<div class="response-message"><div></div></div>
