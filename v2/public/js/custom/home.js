    ...
    $(document).ready(function() {
		...
		if(courses){
			...
			for(i=0; i<data.length; i++){
				...
				html += "<a href='#'><img src='img/poetry.jpg' alt='' /></a>";
				html += "<div class='cat_row'><a href='#'>"+data[i].course_category.name+"</a><span class='pull-right'><i class='icon-clock'></i>6 Days</span></div>";
				html += "</div>";
				html += "<div class='info'>";
				html += "<div class='row'>";
				...
				html += "<p class='btn-add'> <a href='"+base_url + "/subscription-plans'><i class='icon-export-4'></i> Subscribe</a></p>";
				html += "<p class='btn-details'> <a href='"+base_url + "/course/"+data[i].shortname+"'><i class='icon-list'></i> Details</a></p>";
				html += "</div>";
				html += "</div>";
				html += "</div>";
				html += "</div>";												
