        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Disabling honor</h4>
                </div>
                <div class="modal-body">
                    Do you really want to disable this honor ?
                </div>
    ...
    <div class="modal fade" id="activate">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">x</button>
                    <h4 class="modal-title">Honor Activation</h4>
                </div>
                <div class="modal-body">
                    Do you really want to activate this honor ?
                </div>
                <div class="modal-footer">
...
<script src="{{asset('js/settings/honors/list.js')}}"></script>
